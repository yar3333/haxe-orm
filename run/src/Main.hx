		...
		if (args.length > 0)
		{
			try
			{
				...
				if (databaseConnectionString != "")
				{
					...
					new OrmGenerator(project, srcPath).generate(new Db(databaseConnectionString), options.get("autogenPackage"), options.get("customPackage"), options.get("ignoreTables"));
					Log.finishSuccess();
				}
				else
				{
