...
class Main 
{
	static function main()
	{
		...
		options.add("autogenPackage", "models.autogenerated", [ "--autogenerated-package", "-a" ], "Package name for autogenerated classes.\nDefault is 'models.autogenerated'.");
		options.add("customPackage", "models", [ "--custom-package", "-c" ], "Package name for your custom classes.\nDefault is 'models'.");
		options.parse(args);
